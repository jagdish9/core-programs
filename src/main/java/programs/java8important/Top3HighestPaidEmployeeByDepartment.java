...
public class Top3HighestPaidEmployeeByDepartment {
    public static void main(String[] args) {
        ...
        Map<String, List<EmployeeC1>> output = employeeList.stream()
                .collect(Collectors.groupingBy(EmployeeC1::getDepartment,
                        Collectors.collectingAndThen(Collectors.toList(),
                                ls -> ls.stream()
                                        .sorted(Comparator.comparingDouble(EmployeeC1::getSalary)
                                                .reversed())
                                        .limit(3)
                                        .toList()
                        )));
        ...
        output.forEach((k, v) -> {
            ...
            v.forEach(d -> System.out.println(d.getName() + " "+ d.getSalary() + " "+ d.getDepartment()));
        });
